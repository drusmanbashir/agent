...
Detailed command guide: `agent/gmail/HELP.md`

New workflow command:
```bash
gmail-agent --config /home/ub/code/agent/agent/gmail/config.yaml gmail-briefing --lookback-days 7
```
...
```bash
gmail-agent --config /home/ub/code/agent/agent/gmail/config.yaml mdt-check --initials UB
```

Current-week desktop popup (Ubuntu):
```bash
gmail-agent --config /home/ub/code/agent/agent/gmail/config.yaml mdt-check --initials UB --week current --desktop-notify
```

Friday notification mode:
```bash
gmail-agent --config /home/ub/code/agent/agent/gmail/config.yaml mdt-check --initials UB --notify-friday
```
