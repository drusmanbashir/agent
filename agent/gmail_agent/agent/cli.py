...
def _run_linkedin_once_via_api() -> None:
    ...
    try:
        ...
        print("Start it with: cd /home/ub/code/agent/agent/linkedin_agent && uvicorn app.main:app --reload --port 8080")
...
def main(argv=None) -> int:
    ...
    if args.cmd == "shortcuts":
        ...
        print("  source /home/ub/code/agent/agent/gmail_agent/keybindings.bash")
        return 0
